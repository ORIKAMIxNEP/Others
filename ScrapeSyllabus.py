...
def ScrapeSyllabus(url):
    ...
    subject = driver.find_element(
        By.XPATH, value="//*[@id='wrap']/div[4]/div/div/div[1]/div/div[1]/h1"
    ).text
    wariaiLabel = driver.find_element(
        By.XPATH, value="//*[@id='MainContent_SubjectSyllabus_wariaiTable']/tbody/tr[1]"
    ).find_elements(By.TAG_NAME, value="th")
    wariaiValue = driver.find_element(
        By.XPATH, value="//*[@id='MainContent_SubjectSyllabus_wariaiTable']/tbody/tr[2]"
    ).find_elements(By.TAG_NAME, value="td")
    ...
    if (
        driver.find_element(
            By.XPATH,
            value="//*[@id='MainContent_SubjectSyllabus_UpdatePanelSyllabus']/div/table/tbody/tr[6]/td[1]",
        ).text
        == "通年"
    ):
        annual = "true"
